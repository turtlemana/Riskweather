...
const RisksImportance = () => {
  ...
  return (
    <section  className="bg-white py-[52px] px-5 pb-10 max-w-1320">
      <h1   className="text-[#111111] mb-4">{router.locale==="ko" ? "리스크의 중요성" : "Importance of Risk"}</h1>
      ...
      <Image  id="Risk" src={router.locale=="ko" ? risk : riskEng} alt="" className="px-4 pt-[60px]" />
    </section>
  );
};
