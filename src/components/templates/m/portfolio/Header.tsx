...
const Header = ({ setIsOpenProfileModal, userProfile }: Props) => {
  ...
  return (
    <main className="mx-auto mb-10 px-5 ">
      ...
      <Image width={50} height={50} unoptimized onError={handleImageError} src={userProfile?.profileImage ? userProfile?.profileImage : '/images/logos/errorLogo.png'}           referrerPolicy="no-referrer"
                loading="eager" alt="" className="w-[72px] h-[72px] mb-3"  />        <Image
          src={pencil}
          alt=""
      ...
      <section className="mb-5">
        ...
        <Image data-tooltip-id="traitExplain" width={50} height={50} className={'w-[44px]'} src={userProfile?.interestedResult ?   `/images/traits/${userProfile?.interestedResult}.svg` : '/images/logos/errorLogo.png'} alt="" />
          ...
          {userProfile?.interestedResult ? 
              ...
              :  router.locale=="ko" ? "위험 성향을 측정하세요" : "Undefined Result"}</h1>
        </article>
      </section>
