      ...
      <div className="overflow-hidden h-full mb-2 ">
        ...
        >
          {carouselData?.map((asset: CarouselData,i:number) => (
              ...
              <WeatherCard2 EXP_CVaRNTS={asset['EXP_CVaRNTS']} exchg={asset['HR_ITEM_NM']} riskDescriptionEn={asset['LV_DSCP_ENG']}  riskDescriptionKr={asset['LV_DSCP_KR']} name={asset['ITEM_ENG_NM']}  ticker={asset['ITEM_CD_DL']} key={i} riskLevel={asset['CVaR_LV']} koreanRiskLevel={asset['CVaR_LV_KR']} maxLoss={asset['CVaRNTS']}  weather={asset['WTHR_ENG_NM']} weatherExplain={asset['WTHR_ENG_DL']} koreanWeatherExplain={asset['WTHR_KR_DL']} />
