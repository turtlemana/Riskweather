...
function App({ Component, pageProps}: AppProps) {
  ...
  return (
    ...
    <Layout {...pageProps}>
      ...
      <Tooltip id="riskIndexExplain" style={{zIndex:289, fontSize:"small" ,fontWeight:"bold", backgroundColor:"transparent"}}>
      <Image src={router.locale=="ko" ? '/images/explain/RiskIndexExplain.svg' : '/images/explain/RiskIndexExplainEng.svg'} alt="" width={350} height={150}/>
...
export async function getStaticProps(ctx:GetStaticPropsContext,{locale}:GetStaticPropsContext) {
   



  return { props: { ...(await serverSideTranslations(locale as string,['common']))} };
