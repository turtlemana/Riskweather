  ...
  return (
    <main className="flex pt-[190px] mb-7 px-5 items-center justify-center min-w-[1024px] ">
      <div className={(`max-w-1320 w-full mx-auto bg-white flex rounded-20 overflow-hidden `) + (locValid ? `items-center` : ``)}>
       ...
       {locValid ? "" : <article className="flex w-full items-center overflow-auto  p-8 cursor-pointer" onClick={()=>{setMapSelect("");setPosition((pos)=>({...pos, zoom:1, coordinates:[35,10], name:""}));setSideMarkers(sideBarMarkers)}}>
           
          {sideMarkers.length<2 ? 
          
          <div className={'flex items-center'}>
          {/* <TfiBackLeft className={'mr-3 mt-1'}/> */}
          <Image
                src={arrow}
                alt=""
          ...
          <article className={(` mt-1 flex-1 overflow-auto items-center justify-center `) + (!locValid ? `slim-scroll` : `customScrollBar`)} >
