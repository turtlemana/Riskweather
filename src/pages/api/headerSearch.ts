...
const handler=async(req:NextApiRequest,res:NextApiResponse)=>{
    ...
    try{
        ...
        const result:ResultItem[]=await executeQuery({
            ...
            query: `SELECT ITEM_KR_NM, HR_ITEM_NM, LV_DSCP_KR, LV_DSCP_ENG, ITEM_CD_DL, ITEM_ENG_NM,CVaR_LV,WTHR_ENG_NM,WTHR_ENG_DL,CVaRNTS,EXP_CVaRNTS,ADJ_CLOSE,ADJ_CLOSE_USD,WTHR_KR_DL,CVaR_LV_KR
            FROM RMS.ALL_ASSETS
            WHERE 1=1
