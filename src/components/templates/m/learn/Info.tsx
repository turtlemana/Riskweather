    ...
    <section  className="bg-white pt-[60px] px-5 pb-[132px]  max-w-1320">
      ...
      <section className="text-gray-600 text-sm">
        <div className="mb-4">
          ...
          리스크 간의 차이를 “RWI”라 합니다. RWI가 커질 때 시장의
          리스크도 커지는 경향이 있습니다.
      ...
      <Image src={router.locale==="ko" ? card2 :card} alt="" className="mx-auto my-10" />
      <div className="text-center">
        <h6 className="mb-7 text-[#111111]">{router.locale==="ko" ? "날씨 정보" : "Weather Info"}</h6>
        <div className="overflow-scroll customScrollBar h-[136px] overflow-y-hidden flex items-center">
          <Image src={router.locale==="ko" ? weatherInfoKr : weatherInfo} alt="" className="min-w-[1017px]" id="Info of RISK"/>
        </div>
      </div>
    </section>
  );
