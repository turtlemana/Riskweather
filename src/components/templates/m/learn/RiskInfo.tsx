...
const RiskInfo = () => {
  ...
  return (
    <section  className="bg-white pt-[60px] pb-10 px-5 max-w-1320">
      <h1   className="text-[#111111] mb-4">{router.locale==="ko" ? "직관적인 리스크 관련 정보 제공" : "Provides risk information intuitively"}​</h1>
      ...
      <Image src={router.locale==="ko" ? infoKr : info} alt="" className="mx-auto"  id="Portfolio"/>
    </section>
  );
};
