...
const Main: NextPage<Props> = ({ isMobile,providers }) => {
  return isMobile ? <MobileComponent providers={providers}/> : <WebComponent providers={providers} />;
};
...
export async function getServerSideProps({locale}:GetServerSidePropsContext) {
  ...
  return {
    ...
    props: {providers, ...(await serverSideTranslations(locale as string,['login']))},
  }
}