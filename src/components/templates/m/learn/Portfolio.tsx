  ...
  return (
    <main   className="bg-white pt-[60px] pb-10 px-5  max-w-1320">
      ...
      <section className="mt-4 text-gray-600 text-sm mb-10">
        ...
        <p className="mb-4">
        매 시간 주요 통화의 환율(매매기준율)을 기준으로 포트폴리오 가격을 업데이트 하며,
        사용자는 새로고침 버튼을 통해, 포트폴리오의 리스크를 최신으로 유지할 수 있습니다.
        </p>
      ...
      <Image src={router.locale==="ko" ? portfolioKr : portfolio} alt="" className="mb-10 mx-auto" />
      <Image src={router.locale==="ko" ? assetKr : asset} alt="" className="mx-auto" id="Profile" />
    </main>
  );
};
